...
Gist
 ...
 Watch 8
  Star 31
  Fork 9 spacialdb/fcm
 Code  Issues 2  Pull requests 0  Wiki  Pulse  Graphs
Branch: master Find file Copy pathfcm/lib/fcm.rb
c0f0093  19 days ago
@kashif kashif use gcm uri for notification end points (#3)
1 contributor
RawBlameHistory     224 lines (189 sloc)  6.33 KB
require 'httparty'
require 'cgi'
require 'json'
